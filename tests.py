...
from library import app as app_module, models
from library.app import app as library_app
...
class LibrarySiteTests(unittest.TestCase):
    ...
    def setUp(self):
        models.Base.metadata.create_all(bind=app_module.db.engine)
        self.app = library_app.test_client()
        models.init_models(app_module.db.session)
        self.session = app_module.db.session

    def tearDown(self):
        models.Base.metadata.drop_all(bind=app_module.db.engine)
    ...
    def test_edituser(self):
        ...
        # Verify that correct phone number is retrieved for fred
        self.assertIn("2222222222", response.data)
        ...
        staff = models.Staff.query.filter(
            and_(models.Staff.username=='fred',
                 models.Staff.f_name=='Freddy',
                 models.Staff.l_name=='Fredderson',
                 ...
                 models.Staff.phone==1,
                 models.Staff.irl==1,
                 models.Staff.email==0,
                 models.Staff.chat==0)).first()
        self.assertIsNotNone(staff)
        ...
        staff = models.Staff.query.filter(
            and_(models.Staff.username=='fred',
                 models.Staff.f_name=='Fred',
                 models.Staff.l_name=='Fredderson',
                 models.Staff.emailaddress=='KentonCountyLibrary@gmail.com',
                 models.Staff.interests=='books',
                 models.Staff.phonenumber=='2222222222',
                 models.Staff.bio=="I am Fred's incomplete bio",
                 models.Staff.phone==1,
                 models.Staff.irl==1,
        ...
        staff = models.Staff.query.filter(
            and_(models.Staff.username=='fred',
                 models.Staff.f_name=='Fred',
                 models.Staff.l_name=='Fredderson',
                 models.Staff.emailaddress=='test@test.net',
                 models.Staff.interests=='books',
                 models.Staff.phonenumber=='1111111',
                 models.Staff.bio=="I am Fred's incomplete bio",
                 models.Staff.phone==1,
                 models.Staff.irl==1,
                 models.Staff.email==0,
        ...
        staff = models.Staff.query.filter(
            and_(models.Staff.username=='fred',
                 ...
                 models.Staff.emailaddress=='test@test.net',
                 models.Staff.interests=='books',
                 models.Staff.phonenumber=='1111111111',
                 models.Staff.bio=="I am Fred's incomplete bio",
                 models.Staff.phone==1,
                 models.Staff.irl==1,
                 models.Staff.email==0,
        ...
        staff = models.Staff.query.filter(
            and_(models.Staff.username=='fred',
                 ...
                 models.Staff.phone==1,
                 models.Staff.irl==1,
                 models.Staff.email==1,
                 models.Staff.chat==1)).first()
        self.assertIsNotNone(staff)
    ...
    def test_add_patroncontact(self):
        ...
        patroncontact = models.PatronContact.query.filter(
            and_(models.PatronContact.username=='fred',
        ...
        self.assertIn("Please enter your name and email address in the contact area",
                      response.data)
        ...
        patroncontact = models.PatronContact.query.filter(
            and_(models.PatronContact.username=='fred',
                 models.PatronContact.name=='Jeff Johnson',
                 models.PatronContact.email=='test@test.net',
                 models.PatronContact.phone=='555-555-5555',
                 models.PatronContact.times=='Anytime')).first()
        self.assertIsNone(patroncontact)
        ...
        patroncontact = models.PatronContact.query.filter(
            and_(models.PatronContact.username=='fred',
                 models.PatronContact.name=='Jeff Johnson',
                 models.PatronContact.email=='test@test.net',
                 models.PatronContact.contact=='email',
                 models.PatronContact.likes=='I like books',
                 models.PatronContact.dislikes=='Sans books',
                 models.PatronContact.comment=='No comment',
                 models.PatronContact.format_pref=='book,eb',
                 models.PatronContact.audience=='adults,children')).first()
        self.assertIsNotNone(patroncontact)
    ...
    def test_edit_patroncontact(self):
        ...
        response = self.app.post("/contact_status/1",
                                 data=dict(status='pending'),
                                 follow_redirects=True)
        self.assertIn("Joe Johnson Patron request status has been updated",
                      response.data)
    ...
    def test_github_ip_check(self):
        ...
        jsonResponse = requests.get("https://api.github.com/meta",
                                    auth=("KentonCountyLibrary-Cincypy",
                                          "CincyPyCoders2000"))
